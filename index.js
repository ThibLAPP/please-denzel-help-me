...
const debatersUpper = debaters.map(x => x.toUpperCas());
...
const duplicate = question9 => {
  question9.map(x => question9.push(x));
  return question9;
};
...
//We recieve a json with some information about an actor named Zach Sirey
...
// I've been proud of my chatbot project, because even if it was far from perfect, with my friend we managed to implement all the functionalities we wanted and needed

// Q18. Describe an ESILV project that you worked on that you’re not so proud of?
//My last year POO project because i couldn't manage to implement a correct UX/UI, so even if it worked, it was quite ugly

// Q19. What are some things you like about the developer tools you use?
//It has been developped to be convenient and has many tools to make the work easier
...
//Because to make a web app, there are many ways to do so, and not one specific method for every problem.
